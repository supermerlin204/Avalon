...
public class AvalonEntityAfterImageParticle extends CustomModelParticle<SkinnedMesh> {
    public AvalonEntityAfterImageParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, AssetAccessor<SkinnedMesh> particleMesh) {
