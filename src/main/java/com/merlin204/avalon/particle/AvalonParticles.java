...
public class AvalonParticles {
    ...
    public static final RegistryObject<SimpleParticleType> AVALON_INTERPOLATION_ENTITY_AFTER_IMAGE = PARTICLES.register("avalon_interpolation_entity_after_image", () -> new SimpleParticleType(true));
